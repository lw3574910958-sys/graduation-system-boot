...
CREATE TABLE `biz_student` (
  ...
  `department_id` BIGINT NULL DEFAULT NULL COMMENT '所属院系 ID(NULL 表示无院系)',
  `gender` TINYINT NOT NULL DEFAULT 1 COMMENT '性别：0-女，1-男',
  `major` VARCHAR(100) NULL DEFAULT NULL COMMENT '专业',
  `class_name` VARCHAR(50) NULL DEFAULT NULL COMMENT '班级',
...
CREATE TABLE `biz_teacher` (
  ...
  `department_id` BIGINT NULL DEFAULT NULL COMMENT '所属院系 ID(NULL 表示无院系)',
  `gender` TINYINT NOT NULL DEFAULT 1 COMMENT '性别：0-女，1-男',
  `title` VARCHAR(50) NULL DEFAULT NULL COMMENT '职称 (教授/副教授等)',
...
CREATE TABLE `biz_document` (
  ...
  `description` TEXT NULL DEFAULT NULL COMMENT '文档描述',
...
CREATE TABLE `biz_grade` (
  ...
  `student_id` BIGINT NOT NULL COMMENT '学生 ID(biz_student.id)',
  `topic_id` BIGINT NOT NULL COMMENT '题目 ID(biz_topic.id)',
  `grade_type` TINYINT NOT NULL DEFAULT 0 COMMENT '成绩类型：0-开题报告，1-中期报告，2-毕业论文，3-综合成绩',
  ...
  `graded_at` DATETIME(3) NULL DEFAULT NULL COMMENT '评分时间',
  `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
  `is_deleted` TINYINT(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
